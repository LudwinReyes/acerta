            ...
            <div className="flex flex-col gap-6 w-full">
              <a href="tel:+51954775210" className="group flex items-center gap-6 bg-white/5 hover:bg-white/10 border border-white/10 p-4 md:p-6 rounded-full transition-all duration-300 transform hover:scale-[1.02] backdrop-blur-md">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white md:text-xl font-light tracking-wide">+51 954 775 210</span>
                </div>
              </a>

              <a href="mailto:contacto@acertaperu.com" className="group flex items-center gap-6 bg-white/5 hover:bg-white/10 border border-white/10 p-4 md:p-6 rounded-full transition-all duration-300 transform hover:scale-[1.02] backdrop-blur-md">
                <div className="w-12 h-12 rounded-full bg-secondary text-white flex items-center justify-center shrink-0">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white md:text-xl font-light tracking-wide">contacto@acertaperu.com</span>
                </div>
              </a>

              <a href="https://www.acertaperu.com" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-6 bg-white/5 hover:bg-white/10 border border-white/10 p-4 md:p-6 rounded-full transition-all duration-300 transform hover:scale-[1.02] backdrop-blur-md">
                <div className="w-12 h-12 rounded-full bg-secondary text-white flex items-center justify-center shrink-0">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white md:text-xl font-light tracking-wide">www.acertaperu.com</span>
                </div>
              </a>
            </div>
          </div>
